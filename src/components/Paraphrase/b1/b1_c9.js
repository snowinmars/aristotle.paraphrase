...
Далее, ни одно доказательство существования эйдосов не убедительно. В самом деле: то доказывают так, что эйдосы появляются для того, для чего их быть не может; то в доказательстве вообще нет логики. <ul><li>Рассмотрим первый случай - доказательства от знания.<sup>(п1)</sup> Согласно ему, эйдосы должны были бы иметься для всего, что мы знаем.</li><li>Согласно доводу "единого во многом"<sup>(п2)</sup> эйдосы должны существовать и для отрицаний.</li><li>А на основании "довода об исчезновении"<sup>(п3)</sup> эйдосы должны существовать и для того, что может исчезнуть из материального мира.</li></ul> Эти выводы противоречат друг другу. А иногда приводят ещё более интересное утверждение о третьем человеке <sup>(п4)</sup>.

[ref:origin 2]
[ref:paraphrase-notes 4]
И, вообще говоря, доводы в пользу существования эйдосов сводят на нет то, что для Платона важнее самих эйдосов. Из этих доводов следует<sup>(п5)</sup>, что двоица не является первопричиной, формирующей "избыток" и "недостаток". То есть следствие существование эйдосов противоречит изначальному утверждению о том, что эйдосы формируются через пару "изыбток-недостаток".
...
[ref:origin 9]
Затем, философия эйдосов считает, что всё образовывается из двойки или пары. Из этого слдедует, что каждая из единиц, содержащихся в двойке, образовывается из некоторой предшествующей двойки, хотя это невозможно.
...
<sup>(п6)</sup> <span class="help">Также и то, что кажется легким делом, - доказать, что все едино, этим способом не удается, ибо через отвлечение (ekthesis) получается не то, что все едино, а то, что есть некоторое само-по-себе-единое, если даже принять все [предпосылки]. Да и этого самого-посебе-единого не получится, если не согласиться, что общее есть род; а это в некоторых случаях невозможно.</span>
