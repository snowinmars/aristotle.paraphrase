...
[ref:origin 9]
Затем, философия эйдосов считает, что всё образовывается из двойки или пары. Из этого следует, что каждая из единиц, содержащихся в двойке, образовывается из некоторой предшествующей двойки, хотя это невозможно.
...
[ref:origin 12]
Как, согласно Платону, начала формируют сущности? Через синтез "избытка" и "недостатка". Линия - из длинного и короткого, плоскость - из широкого и узкого, тело - из высокого и низкого. Однако, непонятно, как в таком случае плоскость будет содержать линию? Ведь "широкое и узкое" относится к другому роду, нежели "высокое и низкое". Получается, в "нижних" родах не будут содержаться "верхние", то есть плоскость не может содержать линию, а это неверно.
