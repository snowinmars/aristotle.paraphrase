...
type AccordionToggleProperties = {
  children: React.ReactNode,
  eventKey: string
}

const ContextAwareToggle = ({ children, eventKey }: AccordionToggleProperties) => {
  ...
  return (
    <Accordion.Toggle
      as={Card.Header}
      eventKey={eventKey}
      className={isCurrentEventKey ? 'prf-open' : '' }
    >
      {children}
    </Accordion.Toggle>
  );
